...
-- Source ~./config/hypr/hyprland/hyprland.monitors
require("hyprland.monitors")

-- Source ~./config/hypr/hyprland/hyprland.autostart
...
-- Source ~./config/hypr/hyprland/hyprland.layout
require("hyprland.layout")

-- Source ~./config/hypr/hyprland/hyprland.misc
require("hyprland.misc")

-- Source ~./config/hypr/hyprland/hyprland.input
require("hyprland.input")

-- Source ~./config/hypr/hyprland/hyprland.workspace
